...
# Use macOS 14.5 deployment target to ensure compatibility
# This helps avoid issues with missing headers in newer SDKs
echo 'mac_deployment_target="14.5"' >> "$_src_dir/out/Default/args.gn"
